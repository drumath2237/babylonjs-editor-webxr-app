...
var scripts_map_1 = require("../scripts-map");
/**
...
function runScene(scene, rootUrl) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            tools_1.attachScripts(scripts_map_1.scriptsMap, scene);
            // Configure post-processes
            tools_1.configurePostProcesses(scene, rootUrl);
            // Rendering groups
            tools_1.setupRenderingGroups(scene);
            return [2 /*return*/];
        });
    });
}
 ...
 */
function attachScriptToObjectImmediately(scriptPath, object) {
    tools_1.attachScriptToNodeAtRumtine(scripts_map_1.scriptsMap, scriptPath, object);
}
exports.attachScriptToObjectImmediately = attachScriptToObjectImmediately;
